                    ...
                    <div>
                        <form action="{{ route("alternatif.store") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="kode" class="input input-bordered w-full cursor-default bg-slate-100 text-reno-sand" value="{{ old("kode") }}" required readonly />
                                @error("kode")
                                    <div class="label">
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="alternatif" class="input input-bordered w-full text-reno-sand" value="{{ old("alternatif") }}" required />
                                @error("alternatif")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                            ...
                            <label class="form-control w-full">
                                ...
                                <textarea class="textarea textarea-bordered w-full text-reno-sand" name="keterangan">{{ old("keterangan") }}</textarea>
                                @error("keterangan")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                ...
                <div class="modal-box">
                    ...
                    <div>
                        <label class="form-control w-full">
                            ...
                            <input type="text" name="kode" class="input input-bordered w-full text-reno-sand" required readonly />
                            @error("kode")
                                <div class="label">
                                    <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                </div>
                        ...
                        <label class="form-control w-full">
                            ...
                            <input type="text" name="alternatif" class="input input-bordered w-full text-reno-sand" required readonly />
                            @error("alternatif")
                                <div class="label">
                                    <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                </div>
                        ...
                        <label class="form-control w-full">
                            ...
                            <textarea class="textarea textarea-bordered w-full text-reno-sand" name="keterangan" readonly></textarea>
                            @error("keterangan")
                                <div class="label">
                                    <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                </div>
                    ...
                    <div>
                        <form action="{{ route("alternatif.update") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="kode" class="input input-bordered w-full cursor-default bg-slate-100 text-reno-sand" required readonly />
                                @error("kode")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="alternatif" class="input input-bordered w-full text-reno-sand" required />
                                @error("alternatif")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                            ...
                            <label class="form-control w-full">
                                ...
                                <textarea class="textarea textarea-bordered w-full text-reno-sand" name="keterangan"></textarea>
                                @error("keterangan")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                    ...
                    <div>
                        <form action="{{ route("alternatif.import") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="file" name="import_data" class="file-input file-input-bordered w-full text-reno-sand" required />
                                @error("import_data")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
